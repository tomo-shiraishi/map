...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="demo-row typography-row">
      	...
      	<div class="demo-content">
	          ...
	          <img src="/flatui/docs/assets/img/example-image.jpg" alt="example-image" class="img-rounded img-responsive">
      ...
      <div class="demo-illustrations">
        <div class="demo-content">
          <div><img src="/flatui/img/icons/svg/toilet-paper.svg" alt="Toilet-Paper"></div>
          <div><img src="/flatui/img/icons/svg/gift-box.svg" alt="Gift-Box"></div>
          <div><img src="/flatui/img/icons/svg/pencils.svg" alt="Pensils"></div>
          <div><img src="/flatui/img/icons/svg/clipboard.svg" alt="Clipboard"></div>
          <div><img src="/flatui/img/icons/svg/retina.svg" alt="Retina"></div>
          <div><img src="/flatui/img/icons/svg/compas.svg" alt="Compas"></div>
          <div><img src="/flatui/img/icons/svg/map.svg" alt="Map"></div>
          <div><img src="/flatui/img/icons/svg/chat.svg" alt="Chat"></div>
          <div><img src="/flatui/img/icons/svg/mail.svg" alt="Mail"></div>
          <div><img src="/flatui/img/icons/svg/book.svg" alt="Book"></div>
          <div><img src="/flatui/img/icons/svg/calendar.svg" alt="Calendar"></div>
          <div><img src="/flatui/img/icons/svg/paper-bag.svg" alt="Pocket"></div>
          <div><img src="/flatui/img/icons/svg/clocks.svg" alt="Watches"></div>
          <div><img src="/flatui/img/icons/svg/loop.svg" alt="Infinity-Loop"></div>
        </div>
      </div>
      ...
      <div class="row demo-tiles">
        <div class="col-xs-3">
          <div class="tile">
            <img src="/flatui/img/icons/svg/compas.svg" alt="Compas" class="tile-image big-illustration">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="/flatui/img/icons/svg/loop.svg" alt="Infinity-Loop" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile">
            <img src="/flatui/img/icons/svg/pencils.svg" alt="Pensils" class="tile-image">
        ...
        <div class="col-xs-3">
          <div class="tile tile-hot">
            <img src="/flatui/img/icons/svg/ribbon.svg" alt="ribbon" class="tile-hot-ribbon">
            <img src="/flatui/img/icons/svg/chat.svg" alt="Chat" class="tile-image">
      ...
      <div class="login">
        <div class="login-screen">
          <div class="login-icon">
            <img src="/flatui/img/login/icon.png" alt="Welcome to Mail App" />
      ...
      <div class="row">
        <div class="col-xs-9">
          <div class="demo-browser">
            ...
            <div class="demo-browser-content">
              <img src="/flatui/docs/assets/img/demo/browser-pic-1.jpg" alt="" />
              <img src="/flatui/docs/assets/img/demo/browser-pic-2.jpg" alt="" />
              <img src="/flatui/docs/assets/img/demo/browser-pic-3.jpg" alt="" />
              <img src="/flatui/docs/assets/img/demo/browser-pic-4.jpg" alt="" />
              <img src="/flatui/docs/assets/img/demo/browser-pic-5.jpg" alt="" />
              <img src="/flatui/docs/assets/img/demo/browser-pic-6.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="col-xs-3">
          <div class="demo-download">
            <img src="/flatui/docs/assets/img/demo/html-icon.png" src="Free PSD" />
          </div>
        ...
        <div class="row">
          <div class="col-xs-7">
            ...
            <a class="footer-brand" href="http://designmodo.com" target="_blank">
              <img src="/flatui/docs/assets/img/footer/logo.png" alt="Designmodo.com" />
            </a>
          </div> <!-- /col-xs-7 -->
    ...
    <script>
      videojs.options.flash.swf = "/flatui/dist/js/vendors/video-js.swf"
    </script>
  </body>
</html>
